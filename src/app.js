const handlers = {
  ...
  'AMAZON.HelpIntent': function () {
    this.emit(':ask', 'Say something like, "My overall mood is 8 out of 10", or "I am feeling ninety percent happy".');
  },
  'Unhandled': function () {
    this.emit(':ask', 'Sorry, I\'m not sure how to handle that one.');
  }
};
